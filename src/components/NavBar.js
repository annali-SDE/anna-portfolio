...
import useThemeSwistcher from './hooks/useThemeSwitcher';
...
const NavBar = () => {
	const [mode, setMode] = useThemeSwistcher();
		...
		<header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
			...
			<div className='w-full flex justify-between items-center lg:hidden'>
				...
				<nav className='flex items-center justify-center flex-wrap'>
					<motion.a
						href='https://www.linkedin.com/in/anna-h-li/'
						target={'_blank'}
						whileHover={{ y: -2 }}
						whileTap={{ scale: 0.9 }}
						className='w-6 mx-3'
					...
					<motion.a
						href='https://github.com/annali-SDE'
						target={'_blank'}
						whileHover={{ y: -2 }}
						whileTap={{ scale: 0.9 }}
						className='w-6 mx-3'
